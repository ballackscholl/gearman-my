...
public interface Constants {                                                    //NOPMD (Suppress replace interface with class warning)
    ...
    public static final int GEARMAN_SEND_BUFFER_SIZE = 8192*50;
    public static final int GEARMAN_RECV_BUFFER_SIZE = 8192*50;
    ...
    public static final String GEARMAN_STATISTICS_LOGGER_NAME = 
    		"org.gearman.statistics.logger";
